...
class GATConv(MessagePassing):
    ...
    def forward(self, x, edge_index, size=None, edge_weight=None):
        ...
        #     edge_index, edge_weight = add_self_loops(edge_index, edge_weight=edge_weight,  num_nodes=x.size(0))
    ...
    def message(self, edge_index_i, x_i, x_j, size_i, norm):
        ...
        norm = norm.unsqueeze(dim=-1).repeat(1,self.heads) # repeat it for several times
        return norm.view(-1,self.heads, 1) *x_j * alpha.view(-1, self.heads, 1)
